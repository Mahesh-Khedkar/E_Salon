    ...
    <div>
        ...
        <div className='divContainer'>
            ...
            <div className='div2'>
                ...
                <p style={{marginLeft:'40px', borderBottom:'2px solid black'}}> Simple hair cut</p>
                <h5 style={{textAlign:'center',marginTop:'10px'}}> <b>Total</b></h5>
                <p style={{textAlign:'center',marginTop:'10px'}}> Combine service time.</p>
                <h5 style={{textAlign:'center',marginTop:'10px'}}> <b>2 Hrs.</b></h5>
                <Button style={{marginLeft:'100px',marginTop:'10px',backgroundColor:'black',borderRadius:'20px'}}onClick={()=> navigate('/book')}> 
                 Select staff</Button>
            </div>
        </div>
    </div>
